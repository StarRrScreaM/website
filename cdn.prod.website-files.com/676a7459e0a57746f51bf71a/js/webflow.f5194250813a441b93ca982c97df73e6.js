      ...
      var E = (function (l, v, I) {
        ...
        function j(te, Q) {
          ...
          return (
            ...
            (F.open = function (Oe) {
              if (
                ((oe = {}),
                  L(Oe) ? (oe = Oe.call(F, Le, Ee, F, te)) : A(Oe) && (oe = Oe),
                  A(oe))
              )
        ...
        p = {
          ease: [
            ...
            function (l, v, I, A) {
              ...
              return (
                v +
                I * (-2.75 * w * L + 11 * L * L + -15.5 * w + 8 * L + 0.25 * l)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (l, v, I, A) {
              ...
              return (
                v +
                I * (0.3 * w * L + -1.6 * L * L + 2.2 * w + -1.8 * L + 1.9 * l)
              );
            },
          ],
          "ease-in-out": [
        ...
        W = function (l) {
          ...
          for (v = 0; v < L.length; v++)
            A += L[v].charAt(0).toUpperCase() + L[v].slice(1);
        ...
        R = E(function (l) {
          ...
          (l.init = function (w, j, te, Q) {
            ...
            te[2] && (F = te[2]),
              ...
              (this.ease = I(j[2], this.ease, L.ease)),
          ...
          (l.init = function (I) {
            ...
            (l.render = function (I) {
              ...
              for (A = w; A--;)
                (L = this.tweens[A]),
                  L.context &&
                  (L.render(I), (this.current[L.name] = L.value), (j = !0));
              return j
          ...
          var V,
            ...
            Ne = function () {
              ...
              ve < M
                ...
                : ((V = null), W || ((me = T.apply(Z, ee)), (Z = ee = null)));
            };
          return function () {
...
` +
  ...
  var vl = c((q5, hl) => {
    ...
    function YO(e, t, n, r, o, i) {
      ...
      if (p && !h)
        return (
          i || (i = new mi()),
          a || HO(e) ? XO(e, t, n, r, o, i) : kO(e, t, u, n, r, o, i)
        );
      if (!(n & zO)) {
  ...
  var xi = c((Mi) => {
    ...
    var $e = 1.70158,
      IS = (0, Kn.default)(0.25, 0.1, 0.25, 1),
      TS = (0, Kn.default)(0.42, 0, 1, 1),
      OS = (0, Kn.default)(0, 0, 0.58, 1),
      bS = (0, Kn.default)(0.42, 0, 0.58, 1);
    function AS(e) {
      return Math.pow(e, 2);
    }
    function SS(e) {
  ...
  var Xf = c((Gi) => {
        ...
        switch (t.type) {
          ...
          case Iw: {
            let {
              ...
              u = e;
            return (
              (0, Yn.getIn)(u, [n, r]) !== r && (u = Bf(u, r, a, n, i)),
              Ui(u, n, s, o, i)
            );
          }
          case Tw: {
    ...
    function Bf(e, t, n, r, o) {
      let i =
        n === fw ? (0, Yn.getIn)(o, ["config", "target", "objectId"]) : null;
      return (0, Yn.mergeIn)(e, [r], { id: r, ref: t, refId: i, refType: n });
    }
  ...
  var Ud = c((uo) => {
    ...
    var {
      ...
      Pd = (e) => e.trim(),
      oo = Object.freeze({ [Ut]: Rd, [Gt]: _C, [Vt]: yC }),
      Md = Object.freeze({
    ...
    var NC = (e, t) => e === t;
    function LC({ store: e, select: t, onChange: n, comparator: r = NC }) {
    ...
    function ao({
      ...
      if (
        (G
          ? ((X = N.limitAffectedElements), (k = J), (K = s(N)))
          : (k = K = s({ id: y, selector: _, selectorGuids: S })),
          t && C)
      ) {
        let x = n && (K || C === !0) ? [n] : u(J);
        if (K) {
    ...
    function PC({ element: e, actionItem: t }) {
    ...
    var bd = /px/,
      MC = (e, t) =>
        t.reduce(
          (n, r) => (n[r.type] == null && (n[r.type] = XC[r.type]), n),
          e || {}
        ),
      xC = (e, t) =>
        t.reduce(
    ...
    function GC({ element: e, actionItem: t, elementApi: n }) {
    ...
    function zC(e, t, n, r, o) {
      ...
      gt(e, Ae.TRANSFORM_PREFIXED, o),
        ...
        jC(r, n) && a(e, Ae.TRANSFORM_STYLE_PREFIXED, hC);
    }
    function KC(e, t, n, r) {
    ...
    function jC({ actionTypeId: e }, { xValue: t, yValue: n, zValue: r }) {
      return (
        (e === xt && r !== void 0) ||
        (e === Dt && r !== void 0) ||
    ...
    var Vd = we(),
      ...
      NN = (e, t) => {
        ...
        for (let X = 0, { length: k } = o; X < k; X++) {
          let { keyframe: K, actionItems: J } = o[X];
          if ((X === 0 && (b = J[0]), S >= K)) {
            b = J[0];
            let x = o[X + 1],
              T = x && S !== K;
            (C = T ? x.actionItems[0] : null),
              T && ((P = K / 100), (N = (x.keyframe - K) / 100));
          }
        }
        let G = {};
        if (b && !C)
        ...
        return (0, Xt.merge)(e, { position: _, current: G });
      },
      LN = (e, t) => {
        let {
          active: n,
  ...
  var ap = c((e7, op) => {
    var Jd = "\\ud800-\\udfff",
      ...
      rp = E1 + "?",
      ip = "[" + p1 + "]?",
      v1 = "(?:" + h1 + "(?:" + [ep, tp, np].join("|") + ")" + ip + rp + ")*",
      _1 = ip + rp + v1,
      y1 = "(?:" + [ep + Eo + "?", Eo, tp, np, g1].join("|") + ")",
      Zd = RegExp(ho + "(?=" + ho + ")|" + y1 + _1, "g");
    function m1(e) {
  ...
  var lp = c((n7, cp) => {
    ...
    function P1(e) {
      if (e == null) return 0;
      if (w1(e)) return R1(e) ? C1(e) : e.length;
      var t = S1(e);
  ...
  var vp = c((a7, hp) => {
    var U1 = _o(),
      G1 = An(),
      V1 = Object.prototype,
      B1 = V1.hasOwnProperty;
    function X1(e, t, n) {
      var r = e[t];
      (!(B1.call(e, t) && G1(r, n)) || (n === void 0 && !(t in e))) &&
        U1(e, t, n);
    }
    hp.exports = X1;
  });
  ...
  var Jp = c((O7, Zp) => {
    ...
    function cP(e, t, n) {
      ...
      return (
        ...
        aP(e, t, { leading: r, maxWait: t, trailing: o })
      );
    }
    Zp.exports = cP;
  });
  var rr = c((mo) => {
    ...
    var eg = we(),
      ...
      { reifyState: PP } = fP.IX2VanillaUtils,
      MP = (e) => ({ type: dP, payload: { ...PP(e) } }),
      xP = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({
        type: pP,
        payload: { hasBoundaryNodes: e, reducedMotion: t },
      }),
      DP = () => ({ type: gP }),
      FP = () => ({ type: EP }),
      qP = ({ rawData: e, defer: t }) => ({
        type: hP,
      ...
      GP = (e) => ({ type: _P, payload: { actionListId: e } }),
      VP = () => ({ type: yP }),
      BP = (e, t) => ({ type: mP, payload: { target: e, listenerParams: t } }),
      XP = (e = 1) => ({ type: IP, payload: { step: e } }),
      kP = (e, t) => ({ type: TP, payload: { stateKey: e, newState: t } }),
      WP = (e, t) => ({ type: OP, payload: { now: e, parameters: t } }),
      HP = (e, t) => ({ type: bP, payload: { key: e, value: t } }),
      zP = (e) => ({ type: AP, payload: { ...e } }),
      KP = (e, t) => ({ type: SP, payload: { instanceId: e, time: t } }),
      YP = (e) => ({ type: wP, payload: { instanceId: e } }),
      jP = (e, t, n, r) => ({
        type: RP,
        payload: { elementId: e, actionTypeId: t, current: n, actionItem: r },
      }),
      QP = ({ actionListId: e, isPlaying: t }) => ({
        type: CP,
        payload: { actionListId: e, isPlaying: t },
      }),
      $P = ({ width: e, mediaQueries: t }) => ({
        type: NP,
  ...
  var rg = c((To) => {
    ...
    var EM = Element.prototype.closest
  ...
  var wE = c((Mo) => {
    ...
    var {
      ...
      { getNamespacedParameterId: fE } = Ux.IX2VanillaUtils,
      OE = (e) => (t) => typeof t == "object" && e(t) ? !0 : t,
      dn = OE(({ element: e, nativeEvent: t }) => e === t.target),
      aD = OE(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      Ye = (0, Dx.default)([dn, aD]),
      bE = (e, t) => {
        if (t) {
          let { ixData: n } = e.getState(),
            { events: r } = n,
      ...
      Lo = { types: No },
      uD = { PAGE_START: IE, PAGE_FINISH: mE },
      fn = (() => {
      ...
      hD = {
        ...
        [jx]: fr(),
        [Qx]: dr(),
        [iD]: { types: "ecommerce-cart-open", handler: Ve(Ye, Ce) },
        [rD]: { types: "ecommerce-cart-close", handler: Ve(Ye, Ce) },
        [Gx]: {
          types: "click",
          handler: Ve(
            Ye,
          ...
          handler: (
            ...
            switch (a) {
              ...
              case ht.EventBasedOn.PAGE: {
                ...
                _ = y ? Math.min(C + g, N) / N : Math.min(P + m, G) / G;
                break;
              }
              ...
              default: {
                ...
                let P = t.getBoundingClientRect(),
                  { left: N, top: G, width: X, height: k } = P;
                if (!C && !pD({ left: E, top: p }, P)) break;
                (b = !0), (_ = y ? (E - N) / X : (p - G) / k);
                break;
              }
            }
  ...
  var xo = c((ko) => {
    ...
    var SD = Object.keys(Me.QuickEffectIds),
      ...
      WD = 12;
    function HD(e) {
      vt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: YD }),
        vt({
          store: e,
    ...
    function YD({ rawData: e, defer: t }, n) {
      let r = () => {
    ...
    function jD(e, t) {
      ...
      if (r && o && h && s) {
        ...
        E && (h = xD({ actionList: E, actionItemId: o, rawData: h }));
      }
      if (
        ...
        Go({ store: t, actionListId: r }),
          FE({ store: t, actionListId: r, eventId: i });
        let E = Vo({
          store: t,
          eventId: i,
          actionListId: r,
    ...
    function QD({ actionListId: e }, t) {
      e ? Go({ store: t, actionListId: e }) : qE({ store: t }), _r(t);
    }
    function $D(e, t) {
      ...
      let n = (r) => {
        ...
        o.active &&
          (e.dispatch((0, he.animationFrameChanged)(r, i)),
            t ? KD(e, n) : requestAnimationFrame(n));
      };
    ...
    function tF({
      ...
      _.forEach((C) => {
        let { keyframe: P, actionItems: N } = C;
        N.forEach((G) => {
        ...
        O.forEach(({ element: C, key: P }) => {
          let N = y[P],
            ...
            K = (
              ...
              ? Uo(X)(C, G)
              : null,
            J = qo({ element: C, actionItem: G, elementApi: ye }, K);
          Bo({
            store: e,
            element: C,
            eventId: r,
    ...
    function cF({ logic: e, store: t, events: n }) {
      ...
      (0, gn.default)(s, (E, p) => {
        ...
        VD(O, i.mediaQueryKeys) || t.dispatch((0, he.mediaQueriesDefined)()),
          ...
          (Array.isArray(g.config) ? g.config : [g.config]).forEach((b) => {
            let { continuousParameterGroupId: C } = b,
              P = (0, at.default)(a, `${_}.continuousParameterGroups`, []),
              N = (0, _D.default)(P, ({ id: k }) => k === C),
              G = (b.smoothing || 0) / 100,
          ...
          (m.actionTypeId === Me.ActionTypeConsts.GENERAL_START_ACTION ||
            Do(m.actionTypeId)) &&
          FE({ store: t, actionListId: _, eventId: y });
      });
      let u = (E) => {
    ...
    function Bo(e) {
      ...
      vt({ store: t, select: ({ ixInstances: N }) => N[p], onChange: GE }),
      ...
      if (Er(G, C.mediaQueryKey) && (r || n || o)) {
        if (f || (u === wD && o)) {
          ...
          let { ixElements: X } = t.getState(),
            { ref: k, refType: K, refState: J } = X[i] || {},
            x = J && J[s];
  ...
  var jE = c((r6, YE) => {
    ...
    var zo = window.jQuery,
      ...
      Ir = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), zo(t).triggerHandler(je.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), zo(t).triggerHandler(je.types.OUTRO));
        },
      };
    je.triggers = {};
    je.types = { INTRO: "w-ix-intro" + KE, OUTRO: "w-ix-outro" + KE };
    je.init = function () {
    ...
    st.define(
      ...
      (JE.exports = function (e, t) {
        ...
        function ie(d, D) {
          ...
          var A = l + Je;
          r(d.menu).add(I).set({ y: -A }).start({ y: 0 }).then(L);
          function L() {
    ...
    Or.define(
      ...
      (nh.exports = function (e, t) {
        ...
        function G(R, B) {
          ...
          if (
            ((U.handler = null),
              (U.redirect = Y.attr("data-redirect")),
              b.test(ae))
          ) {
            U.handler = ee;
            return;
        ...
        function x(R) {
          var B = {};
          return (
            R.find(':input[type="file"]').each(function (Y, U) {
              var ne = e(U),
                ie =
                  ne.attr("data-name") || ne.attr("name") || "File " + (Y + 1),
            ...
            B === "password"
              ...
              : R.attr("required")
                ? U
                  ? h.test(R.attr("type")) &&
                  (E.test(U) ||
                    (ne = "Please enter a valid email address for: " + Y))
                  : (ne = "Please fill out the required field: " + Y)
        ...
        function ee(R) {
          ...
          t.each(Y, function (d, D) {
            h.test(D) && (Y.EMAIL = d),
              ...
              /^(first[ _-]?name)$/i.test(D) && (Y.FNAME = d),
              /^(last[ _-]?name)$/i.test(D) && (Y.LNAME = d);
          }),
            ne &&
            !Y.FNAME &&
            ((ne = ne.split(" ")),
              (Y.FNAME = ne[0]),
              (Y.LNAME = Y.LNAME || ne[1]));
          ...
          (z = ie.substring(z, ie.indexOf("&", z))),
            (Y["b_" + ae + "_" + z] = ""),
            e
              .ajax({ url: ie, data: Y, dataType: "jsonp" })
              .done(function (d) {
          ...
          if (
            ...
            Je.on("click keydown", function (Q) {
              ...
              d.on("change", function (Q) {
                (Y = Q.target && Q.target.files && Q.target.files[0]),
                  Y &&
                  (ne.toggle(!1),
                    z.toggle(!1),
                    ie.toggle(!0),
        ...
        function Ne(R, B) {
          var Y = new URLSearchParams({ name: R.name, size: R.size });
          e.ajax({ type: "GET", url: `${O}?${Y}`, crossDomain: !0 })
            .done(function (U) {
              B(null, U);
            })
            .fail(function (U) {
  ...
  Webflow.require("ix2").init({
    events: {
      ...
      "e-109": {
        ...
        mediaQueries: ["main", "medium", "small", "tiny"],
        target: {
          id: "676a7459e0a57746f51bf775|7fb00867-5f69-d347-3936-19135aef3ce1",
          appliesTo: "ELEMENT",
          styleBlockIds: [],
        },
        targets: [],
      ...
      "e-NEW_SPOILER": {
        ...
        action: {
          ...
          config: {
            ...
            affectedElements: {},
            playInReverse: !1,
            autoStopEventId: "e-NEW_SPOILER-rev",
          },
        },
        mediaQueries: ["main", "medium", "small", "tiny"],
        target: {
          id: "676a7459e0a57746f51bf775|NEW_SPOILER_QUESTION",
          appliesTo: "ELEMENT",
          styleBlockIds: [],
        },
        targets: [
        ...
        createdOn: 1735125539765,
      },
      "e-NEW_SPOILER-rev": {
        id: "e-NEW_SPOILER-rev",
        name: "",
        animationType: "preset",
        eventTypeId: "MOUSE_SECOND_CLICK",
        action: {
        ...
        createdOn: 1735125539766,
      },
      "e-NEW_SPOILER_CHANGELOG": {
        id: "e-NEW_SPOILER_CHANGELOG",
        name: "",
        animationType: "preset",
        eventTypeId: "MOUSE_CLICK",
        action: {
          ...
          config: {
            ...
            affectedElements: {},
            playInReverse: false,
            autoStopEventId: "e-NEW_SPOILER_CHANGELOG-rev"
          }
        },
        mediaQueries: ["main", "medium", "small", "tiny"],
        target: {
          id: "676a7459e0a57746f51bf775|NEW_SPOILER_CHANGELOG",
          appliesTo: "ELEMENT",
          styleBlockIds: []
        },
        targets: [
      ...
      "e-NEW_SPOILER_CHANGELOG-rev": {
        id: "e-NEW_SPOILER_CHANGELOG-rev",
        name: "",
        animationType: "preset",
        eventTypeId: "MOUSE_SECOND_CLICK",
        action: {
          ...
          config: {
            ...
            affectedElements: {},
            playInReverse: false,
            autoStopEventId: "e-NEW_SPOILER_CHANGELOG"
          }
        },
        mediaQueries: ["main", "medium", "small", "tiny"],
        target: {
            ...
            actionItems: [
              ...
              },
              {
                ...
                config: {
                  ...
                  easing: "",
                  duration: 500,
                  target: { id: "0319b77c-5498-76da-a7c8-9b3949859ed0" },
                  value: 0,
                  unit: "",
                },
              },
